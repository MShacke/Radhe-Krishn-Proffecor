...
from utils import get_settings, get_size, is_subscribed, save_group_settings, temp, replace_username 
...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            ...
            InlineKeyboardButton('𝙷𝙴𝙻𝙿 👁️‍🗨️', url=f"https://t.me/{temp.U_NAME}?start=help")
            ]]
    ...
    if len(message.command) != 2:
        ...
        m=await message.reply_sticker("CAACAgUAAxkBAANqZTFP9Hm_-q6UETtKNp8-7Rs4GjYAAh4LAAJPa4lVMTH4voRn4goeBA")
