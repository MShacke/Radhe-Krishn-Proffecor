...
‣ вᴜɪʟᴅ ѕᴛᴀᴛᴜѕ: v2.7.1 [ ѕᴛᴀʙʟᴇ ]</b>"""
    ...
    SOURCE_TXT = """<b>ᴏʏᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ʜᴇʟʟᴏ
    
- ᴍʏ ᴘʀᴏɢʀᴀᴍɪɴɢ ɪꜱ ʜɪᴅᴅᴇɴ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴏᴡɴᴇʀ ᴛᴏ ɢᴇᴛ ᴍʏ ꜱᴇᴄʀᴇᴛ ᴘʀᴏɢʀᴀᴍᴍɪɴɢ ᴄᴏᴅᴇꜱ

- ᴍʏ ɢᴏᴅ <a href=https://t.me/MS_Contact_RoBot>ᴄʟɪᴄᴋ ᴍᴇ</a></b>"""

    FILE_TXT = """➤ ʜᴇʟᴘ: ꜰɪʟᴇ ꜱᴛᴏʀᴇ ᴍᴏᴅᴜʟᴇ..../

<b>ʙʏ ᴜꜱɪɴɢ ᴛʜɪꜱ ᴍᴏᴅᴜʟᴇ, ʏᴏᴜ ᴄᴀɴ ꜱᴛᴏʀᴇ ꜰɪʟᴇꜱ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ, ᴀɴᴅ ɪ ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ ᴀ ᴘᴇʀᴍᴀɴᴇɴᴛ ʟɪɴᴋ ᴛᴏ ᴀᴄᴄᴇꜱꜱ ᴛʜᴇ ꜱᴀᴠᴇᴅ ꜰɪʟᴇꜱ. ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴀᴅᴅ ꜰɪʟᴇꜱ ꜰʀᴏᴍ ᴀ ᴘᴜʙʟɪᴄ ᴄʜᴀɴɴᴇʟ ꜱᴇɴᴅ ᴛʜᴇ ꜰɪʟᴇ'ꜱ ᴜʀʟ ᴏɴʟʏ ᴏʀ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴀᴅᴅ ꜰɪʟᴇꜱ ꜰʀᴏᴍ ᴀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀɴɴᴇʟ, ʏᴏᴜ ᴍᴜꜱᴛ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴏɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴀᴄᴄᴇꜱꜱ ꜰɪʟᴇꜱ...//</b>

⪼ ᴄᴏᴍᴍᴀɴᴅꜱ ᴀɴᴅ ᴜꜱᴀɢᴇ

➪ /plink ›› <b>ʀᴇᴘʟʏ ᴛᴏ ᴀɴʏ ᴍᴇᴅɪᴀ ᴛᴏ ɢᴇᴛ ʟɪɴᴋ.</b>
➪ /pbatch ›› <b>ᴜꜱᴇ ʏᴏᴜʀ ᴍᴇᴅɪᴀ ʟɪɴᴋ ᴡɪᴛʜ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ.</b>
➪ /batch ›› <b>ᴛᴏ ᴄʀᴇᴀᴛᴇ ʟɪɴᴋ ꜰᴏʀ ᴍᴜʟᴛɪᴘʟᴇ ꜰɪʟᴇ.</b>

⪼ 𝐄𝐱𝐚𝐦𝐩𝐥𝐞 ›

<code>/batch https://t.me/MS_Movvies https://t.me/MS_Movvies</code>"""
...
• <code>/g_filter off</code> ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴏᴀɴᴅ + ᴏɴ/ᴏꜰꜰ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ ᴄᴏɴᴛʀᴏʟ ɢʟᴏʙᴀʟ ꜰɪʟᴛᴇʀ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ"""
...
<u>ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴏɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ</u>

• /autofilter on - ᴀᴜᴛᴏꜰɪʟᴛᴇʀ ᴇɴᴀʙʟᴇ ɪɴ ʏᴏʀ ᴄʜᴀᴛ
• /autofilter off - ᴀᴜᴛᴏꜰɪʟᴛᴇʀ ᴇɴᴀʙʟᴇ ɪɴ ʏᴏʀ ᴄʜᴀᴛ 

ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ɪꜱ ᴛʜᴇ ꜰᴇᴀᴛᴜʀᴇ ᴛᴏ ꜰɪʟᴛᴇʀ ᴀɴᴅ ꜱᴀᴠᴇ ᴛʜᴇ ꜰɪʟᴇꜱ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ꜰʀᴏᴍ ᴄʜᴀɴɴᴇʟ ᴛᴏ ɢʀᴏᴜᴘ. ʏᴏᴜ ᴄᴀɴ ᴜꜱᴇ ᴛʜᴇ ꜰᴏʟʟᴏᴡɪɴɢ ᴄᴏᴍᴍᴀɴᴅꜱ ᴛᴏ ꜱᴇᴛ ᴄᴜꜱᴛᴏᴍ ᴛᴇᴍᴘʟᴀᴛᴇ ꜰᴏʀ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ..../

𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂 :-
›› /set_template - ꜱᴇᴛ ᴄᴜꜱᴛᴏᴍ ɪᴍᴅʙ ᴛᴇᴍᴘʟᴀᴛᴇ ꜰᴏʀ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ.
›› /get_template - ɢᴇᴛ ᴄᴜʀʀᴇɴᴛ ɪᴍᴅʙ ᴛᴇᴍᴘʟᴀᴛᴇ ᴏꜰ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ."""
...
<b>NOTE:</b>
ᴍʏ ʙᴏꜱꜱ ɢɪᴠᴇɴ ᴍᴇ ᴛʜᴇꜱᴇ ᴇxᴛʀᴀ ꜰᴇᴀᴛᴜʀᴇꜱ
...
• /clear_junk - ᴄʟᴇᴀʀ ᴀʟʟ ᴅᴇʟᴇᴛᴇ ᴀᴄᴄᴏᴜɴᴛ & ʙʟᴏᴄᴋᴇᴅ ᴀᴄᴄᴏᴜɴᴛ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ
• /clear_junk_group - ᴄʟᴇᴀʀ ᴀᴅᴅ ʀᴇᴍᴏᴠᴇᴅ ɢʀᴏᴜᴘ ᴏʀ ᴅᴇᴀᴄᴛɪᴠᴀᴛᴇᴅ ɢʀᴏᴜᴘꜱ ᴏɴ ᴅʙ"""
...
"""
    ...
    STATUS_TXT = """<b>╔══════❰ sᴛᴀᴛᴜs  ❱═══❍⊱❁۪۪
║╭━━━━━━━━━━━━━━━➣
║┃
║┣⪼𖨠 ғɪʟᴇs sᴀᴠᴇᴅ: <code>{}</code>
║┃
║┣⪼𖨠 ᴜsᴇʀs: <code>{}</code>
║┃
║┣⪼𖨠 ɢʀᴏᴜᴘs: <code>{}</code>
║┃
║┣⪼𖨠 ᴏᴄᴄᴜᴘɪᴇᴅ: <code>{}</code>
║┃
║┣⪼𖨠 ʟᴇғᴛ sᴛᴏʀᴀɢᴇ: <code>{}</code>
║┃
║╰━━━━━━━━━━━━━━━➣ 
╚═════❰ ᴄᴀɴᴄᴇʟʟᴇᴅ ❱═══❍⊱❁۪۪"""
    LOG_TEXT_G = """#𝐍𝐞𝐰𝐆𝐫𝐨𝐮𝐩
...
<b>ᴋɪᴄᴋ ɪɴᴄᴀᴛɪᴠᴇ ᴍᴇᴍʙᴇʀꜱ ꜰʀᴏᴍ ɢʀᴏᴜᴘ. ᴀᴅᴅ ᴍᴇ ᴀꜱ ᴀᴅᴍɪɴ ᴡɪᴛʜ ʙᴀɴ ᴜꜱᴇʀꜱ ᴘᴇʀᴍɪꜱꜱɪᴏɴ ɪɴ ɢʀᴏᴜᴘ.</b>

<b>Commands and Usage:</b>
• /inkick - ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜ ʀᴇQᴜɪʀᴇᴅ ᴀʀɢᴜᴍᴇɴᴛꜱ ᴀɴᴅ ɪ ᴡɪʟʟ ᴋɪᴄᴋ ᴍᴇᴍʙᴇʀꜱ ꜰʀᴏᴍ ɢʀᴏᴜᴘ.
• /instatus - ᴛᴏ ᴄʜᴇᴄᴋ ᴄᴜʀʀᴇɴᴛ ꜱᴛᴀᴛᴜꜱ ᴏꜰ ᴄʜᴀᴛ ᴍᴇᴍʙᴇʀ ꜰʀᴏᴍ ɢʀᴏᴜᴘ.
• /inkick within_month long_time_ago - ᴛᴏ ᴋɪᴄᴋ ᴜꜱᴇʀꜱ ᴡʜᴏ ᴀʀᴇ ᴏꜰꜰʟɪɴᴇ ꜰᴏʀ ᴍᴏʀᴇ ᴛʜᴀɴ 6-7 ᴅᴀʏꜱ.
• /inkick long_time_ago - ᴛᴏ ᴋɪᴄᴋ ᴍᴇᴍʙᴇʀꜱ ᴡʜᴏ ᴀʀᴇ ᴏꜰꜰʟɪɴᴇ ꜰᴏʀ ᴍᴏʀᴇ ᴛʜᴀɴ ᴀ ᴍᴏɴᴛʜ ᴀɴᴅ ᴅᴇʟᴇᴛᴇᴅ ᴀᴄᴄᴏᴜɴᴛꜱ.
• /dkick - ᴛᴏ ᴋɪᴄᴋ ᴅᴇʟᴇᴛᴇᴅ ᴀᴄᴄᴏᴜɴᴛꜱ."""

    IMAGE_TXT = """➤ 𝐇𝐞𝐥𝐩: Iᴍᴀɢᴇ

ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴡɪʟʟ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴇᴅɪᴛ ɪᴍᴀɢᴇ ᴇᴀꜱɪʟʏ
